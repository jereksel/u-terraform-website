...
ifeq ($(PROVIDER_SLUG),)
	...
	-@rm content/source/docs/providers/$(PROVIDER_SLUG).erb
	-@rm content/source/layouts/$(PROVIDER_SLUG)
	# @cd content/source/docs/providers && ln -s ../../../ext/providers/$(PROVIDER_SLUG)/website/$(PROVIDER_SLUG).erb $(PROVIDER_SLUG).erb
	# @cd content/source/layouts && ln -s ../../../../ext/providers/$(PROVIDER_SLUG)/website/docs $(PROVIDER_SLUG)
